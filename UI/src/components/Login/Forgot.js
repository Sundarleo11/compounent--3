...
class Forgot extends Component {
  ...
  getUserDetails = (event) => {
    ...
    /* .get(
     ...
     // .get(`https://lnnp2qppv5.execute-api.us-east-1.amazonaws.com/tweetapp/api/v1.0/tweets/${this.email.current.value}/forgot`)
    . get(
      `https://vad159omfi.execute-api.us-east-1.amazonaws.com/update-pw-v1/api/v1.0/tweets/${this.email.current.value}/forgot`
    )
     .then((res) => {
        this.setState({
  ...
  updatePassword = (event) => {
    ...
    if (this.password1.current.value === this.password2.current.value) {
      ...
      axios
        ...
        //.put("https://lnnp2qppv5.execute-api.us-east-1.amazonaws.com/tweetapp/api/v1.0/tweets/updateUser", body, config)
       
       .put("https://s0ch306vh9.execute-api.us-east-1.amazonaws.com/update-pw-v1/api/v1.0/tweets/updateUser",body, config)
        .then((res) => {
