...
class Main extends Component {
  ...
  getMyTweets = () => {
    axios
      ...
      //.get(`https://lnnp2qppv5.execute-api.us-east-1.amazonaws.com/tweetapp/api/v1.0/tweets/${this.state.email}`)
      .get(`https://w7eobia5cl.execute-api.us-east-1.amazonaws.com/FindById-v1/api/v1.0/tweets/${this.state.email}`)
      .then((res) => {
  ...
  onSubmitHandler = (event) => {
    ...
    axios
     ...
     // .post(`https://lnnp2qppv5.execute-api.us-east-1.amazonaws.com/tweetapp/api/v1.0/tweets/${this.state.email}/add`,body)
     .post(`https://eeo8hxlbk1.execute-api.us-east-1.amazonaws.com/post-tweet-v1/api/v1.0/tweets/${this.state.email}/add`,body)
      .then((res) => {
