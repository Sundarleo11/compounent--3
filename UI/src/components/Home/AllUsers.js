...
class AllUsers extends Component {
  ...
  getAllUsers = () => {
    axios
     ...
     //.get(`https://lnnp2qppv5.execute-api.us-east-1.amazonaws.com/tweetapp/api/v1.0/tweets/users/all`)
      .get(`https://8s27rnr1de.execute-api.us-east-1.amazonaws.com/userdetails-v1/api/v1.0/tweets/users/all`)
      .then((res) => {
