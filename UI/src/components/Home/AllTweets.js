...
class AllTweet extends Component {
  ...
  getTweets = () => {
    axios
     ...
     // .get(`https://lnnp2qppv5.execute-api.us-east-1.amazonaws.com/tweetapp/api/v1.0/tweets/all`)
        .get(`https://tw6tjkmps5.execute-api.us-east-1.amazonaws.com/tweet-all-post-v1/api/v1.0/tweets/all`)
      .then((res) => {
