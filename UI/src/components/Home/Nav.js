...
class Nav extends Component{
    ...
    constructor(props) {
      ...
      updateLogStatus=(event)=>{
        ...
        //  .post(`https://lnnp2qppv5.execute-api.us-east-1.amazonaws.com/tweetapp/api/v1.0/tweets/logout?email=${this.state.email}`)
           .post(`https://vikc5v19z3.execute-api.us-east-1.amazonaws.com/logout-v1/api/v1.0/tweets/logout?email=${this.state.email}`)        
        .then((res) => {
